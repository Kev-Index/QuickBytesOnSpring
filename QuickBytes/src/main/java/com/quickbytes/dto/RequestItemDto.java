...
public class RequestItemDto {
	...
	public RequestItemDto(Long requestId, Float totalPrice, RequestStatus status, LocalDate orderTime,
			...
			String vendorUsername, String vendorUserRole, Long itemId, String itemName, Float itemPrice,
	...
	public String toString() {
		return "RequestItemDto [requestId=" + requestId + ", totalPrice=" + totalPrice + ", status=" + status
				...
				+ ", vendorUsername=" + vendorUsername + ", vendorUserRole=" + vendorUserRole + ", itemId=" + itemId
