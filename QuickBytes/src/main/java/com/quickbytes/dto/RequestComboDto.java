...
public class RequestComboDto {
	...
	private Boolean comboAvailability;
	
	public RequestComboDto() {
		super();
		// TODO Auto-generated constructor stub
	}

	public RequestComboDto(Long requestId, Float totalPrice, RequestStatus status, LocalDate orderTime,
			LocalDate endTime, Long customerId, Integer customerEmployeeId, String customerFirstName,
			String customerLastName, Float customerBalance, Long customerUserId, String customerUsername,
			String customerUserRole, Long vendorId, Integer vendorBusinessId, String vendorName, Long vendorUserId,
			String vendorUsername, String vendorUserRole, Long comboId, String comboName, Float comboPrice,
			Boolean comboAvailability) {
		super();
	...
	public Boolean getComboAvailability() {
		return comboAvailability;
	}

	public void setComboAvailability(Boolean comboAvailability) {
		this.comboAvailability = comboAvailability;
	}

	@Override
	public String toString() {
		return "RequestComboDto [requestId=" + requestId + ", totalPrice=" + totalPrice + ", status=" + status
				...
				+ ", vendorUsername=" + vendorUsername + ", vendorUserRole=" + vendorUserRole + ", comboId=" + comboId
				+ ", comboName=" + comboName + ", comboPrice=" + comboPrice + ", comboAvailability=" + comboAvailability
				+ "]";
	}
}
